class MagenticAnisotropyFlow:
    ...
    def __init__(self, npoints, workdir, cl_calc_settings, ncl_calc_settings, structure, pseudo_settings, symm_reduce = True, angle_range = None, input_spins = None):
        ...
        def set_calculations_h(workdir, spins, machine_settings, cl_calc_settings, ncl_calc_settings, structure, pseudo_settings):
        ...
        [cl_calc, ncl_calc] = set_calculations_h(workdir, spins, machine_settings, cl_calc_settings, ncl_calc_settings, structure, pseudo_settings)
        self._cl_calc = cl_calc
        self._ncl_calc = cl_calc
