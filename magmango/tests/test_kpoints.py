...
class KpointsSettingsTest(unittest.TestCase):
   def setUp(self):
       ...
       self.settings  = {'comment': 'kpoints_pto', 'nkpoints': 0, 'generation_style': 'Gamma', 'kpoints':[[2,2,2]], 'usershift': [0.0, 0.0,0.0], 'kpts_weights': None, 'coord_type': None, 'labels': None, 'tet_number': 0, 'tet_weight': 0, 'tet_connections': None, '@module': 'pymatgen.io.vasp.inputs', '@class': 'Kpoints'}
   ...
   def test_from_file(self):
      ...
      kpoints_infile.from_file(self.kpoints_file_path)
